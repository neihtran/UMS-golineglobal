...
const REPORT_TITLES: Record<string, string> = {
  r01: 'Báo cáo tự đánh giá AUN-QA CTĐT CNTT',
  r02: 'Báo cáo tự đánh giá AUN-QA CTĐT Kinh tế',
  r03: 'Báo cáo tự đánh giá AUN-QA CTĐT CNTT (lần 2)',
};

const EVIDENCE_ITEMS = [
  { id: 'e1', title: 'Syllabus CTĐT CNTT 2024', type: 'Tài liệu', uploadedBy: 'PGS.TS. Lý Văn Hùng', uploadDate: '2026-05-10', status: 'approved', size: '2.4 MB' },
  { id: 'e2', title: 'Kết quả khảo sát sinh viên 2025', type: 'Kết quả khảo sát', uploadedBy: 'TS. Thảo Nguyễn', uploadDate: '2026-04-22', status: 'approved', size: '1.8 MB' },
  { id: 'e3', title: 'Báo cáo giảng dạy HK1/2025-2026', type: 'Báo cáo', uploadedBy: 'GS.TS. Nguyễn Hoàng Long', uploadDate: '2026-03-15', status: 'review', size: '5.1 MB' },
  { id: 'e4', title: 'Danh sách giảng viên có bằng ThS/TS', type: 'Danh sách', uploadedBy: 'Chu Hanh', uploadDate: '2026-02-28', status: 'approved', size: '0.3 MB' },
  { id: 'e5', title: 'Biên bản họp Hội đồng kiểm định', type: 'Biên bản', uploadedBy: 'PGS.TS. Hoàng Thị Lan', uploadDate: '2026-06-01', status: 'pending', size: '1.1 MB' },
  { id: 'e6', title: 'Mẫu đánh giá môn học theo AUN', type: 'Biểu mẫu', uploadedBy: 'TS. Trần Thị Mai Lan', uploadDate: '2026-01-20', status: 'approved', size: '0.8 MB' },
];
...
export default function EvidenceList() {
  ...
  const reportTitle = REPORT_TITLES[id ?? ''] ?? 'Báo cáo';
  const { pagination, setPage, setPageSize } = usePagination({ initialPage: 1, initialPageSize: 10 });

  return (
    <div className="space-y-6">
      <PageHeader
        title={`Minh chứng — ${reportTitle}`}
        description={`QA-01 — Danh sách minh chứng thuộc báo cáo`}
        breadcrumbs={[
          { label: 'QA', href: '/qa' },
        ...
        actions={
          <Button variant="outline" leftIcon={<ArrowLeft className="h-4 w-4" />} onClick={() => navigate(`/qa/bao-cao/${id}`)}>
            Quay lại
          </Button>
        }
      />
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <div className="flex justify-end mt-4">
            <Button leftIcon={<Plus className="h-4 w-4" />} onClick={() => navigate(`/qa/bao-cao/${id}/minh-chung/tao`)}>
              Thêm minh chứng
            </Button>
          </div>
        </CardContent>
