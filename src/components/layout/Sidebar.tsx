...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    modules: [
      { id: 'hrm', label: 'HRM – Nhân sự', route: '/hrm', icon: <Users className="h-4 w-4" />, requiredRoles: [ROLES.ADMIN, ROLES.NHAN_VIEN, ROLES.HIEU_TRUONG, ROLES.PHO_HIEU_TRUONG, ROLES.TRUONG_KHOA, ROLES.PHO_TRUONG_KHOA] },
      ...
      { id: 'hrm-nghi-phep', label: 'Nghỉ phép', route: '/hrm/nghi-phep', icon: <ClipboardList className="h-4 w-4" />, requiredRoles: [ROLES.ADMIN, ROLES.NHAN_VIEN, ROLES.HIEU_TRUONG, ROLES.PHO_HIEU_TRUONG, ROLES.TRUONG_KHOA, ROLES.PHO_TRUONG_KHOA] },
  ...
  },
  {
    ...
    modules: [
      { id: 'sis', label: 'SIS – Sinh viên & Đào tạo', route: '/sis', icon: <GraduationCap className="h-4 w-4" />, requiredRoles: [ROLES.ADMIN, ROLES.GIAO_VIEN, ROLES.NHAN_VIEN, ROLES.TRUONG_KHOA, ROLES.PHO_TRUONG_KHOA, ROLES.HIEU_TRUONG, ROLES.PHO_HIEU_TRUONG] },
      ...
      { id: 'sis-ctdt', label: 'CTĐT', route: '/sis/chuong-trinh-dao-tao', icon: <BookOpen className="h-4 w-4" />, requiredRoles: [ROLES.ADMIN, ROLES.GIAO_VIEN, ROLES.NHAN_VIEN, ROLES.TRUONG_KHOA, ROLES.PHO_HIEU_TRUONG] },
